  ...
  return (
    <nav className="mb-20 flex items-center justify-between py-6">
      ...
      <div className='m-8 flex items-center justify-center gap-4 text-2xl'>
        <a href="https://www.linkedin.com/in/labeebzahed" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <FaLinkedin />
        </a>

        <a href="https://github.com/LabeebZahed03" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          <FaGithub />
        </a>
